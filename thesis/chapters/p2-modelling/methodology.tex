...
Having now discussed how all of the various components of the~\gls{acr:csm} and the \simiir~framework were instantiated for our simulations, we now move to a discussion of how we ran the simulations. We also provide a brief discussion of our evaluation approach. Our simulation runs are based upon the two research questions posed back in Section~\ref{sec:intro:rqs} on page~\pageref{sec:intro:rqs}. As such, we considered two different sets of simulation runs. 
