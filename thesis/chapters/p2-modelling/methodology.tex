...
\begin{itemize}
    \item{the generation of pseudo-realistic \blueboxbold{queries} to issue;}
    \item{the consideration of \blueboxbold{interaction costs and probabilities}.}
\end{itemize}
...
\todo{explain the query generation strategy!}

\subsubsection{Summary and Document Decision Making}

\todo{explain the probabilities of interaction, look at heikkis paper that says that probability of clicking doesnt mean probability of relevance.}

\subsubsection{\gls{acr:serp} Decision Making}

\todo{expain the serp level decision point.}

\subsubsection{Snippet Level Decision Making}

\todo{explain the different stopping strategies, explaining how we instantiated them all.}
