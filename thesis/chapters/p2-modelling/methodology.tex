...
In the example illustration, a simulated searcher examines to a depth of $2$ for \genericblack{Q\textsubscript{0}}, and a depth of $1$ for \genericblack{Q\textsubscript{2}}. The searcher does not even enter the associated~\gls{acr:serp} for \genericblack{Q\textsubscript{1}}, as the~\gls{acr:serp} level stopping decision point prevents the searcher from examining result summaries in detail. The resultant $D/Q$ for the search session is therefore $1$.
