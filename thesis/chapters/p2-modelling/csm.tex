...
\begin{itemize}
    ...
    \item[\blueboxbold{A}]{\darkblueboxbold{Topic Examination} A searcher subscribing to the~\gls{acr:csm} would begin the search process with some new information need. This would typically be provided as a \emph{topic,} with a topic description outlining said information need, and stating explicitly what would constitute a relevant document.}
