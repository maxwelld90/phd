...
\begin{itemize}
    ...
    \item{\dualbluebox{SS10-RELTIME}{Time, Give-Up} Using the \emph{give-up heuristic}~\citep{krebs1974leave_after_rule}, a searcher will abandon a presented~\gls{acr:serp} $x_{10}$ seconds after the last document was considered relevant/useful (saved) to the given information need.}
\end{itemize}
