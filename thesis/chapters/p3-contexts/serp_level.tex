...
One aspect of a~\glsplural{acr:serp} presentation that we do consider in this chapter is the \emph{size of the browser's viewport}. A~\gls{acr:serp} is typically larger than the viewport within which it is displayed, leading to the inclusion of scrollbars. Results can only be seen \emph{above-the-fold}, or what is visible within the viewport.
...
Significant differences when considering the levels of~\gls{acr:cg} attained were observed between \dualbluebox{SERP}{Perfect} and \dualbluebox{SERP}{Always}, as well as between \dualbluebox{SERP}{Perfect} and \dualbluebox{SERP}{Average}. This was true across all result summary level stopping strategies, over both \blueboxbold{T2} and \dualbluebox{ND}{AD}. Considering \blueboxbold{SS1-FIX} over interface \blueboxbold{T2}, we observed the following:
