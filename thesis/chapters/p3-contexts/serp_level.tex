...
Overall, this table provides further evidence to support \darkblueboxbold{RQ1} -- the new~\gls{acr:serp} level stopping decision point implementation does indeed yield improvements in performance.
