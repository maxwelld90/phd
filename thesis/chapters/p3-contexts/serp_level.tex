...
\begin{itemize}
    \item[]{\darkblueboxbold{HL-RQ1} \emph{How can we improve searcher models to incorporate different stopping decision points?}}
\end{itemize}
...
\begin{table}[t!]
    \caption[\emph{P(E|HS)} and \emph{P(E|LS)} probabilities, with v\textsubscript{size}]{Probabilities of examining high \emph{P(E|HS)} and low scent~\glsplural{acr:serp} \emph{P(E|LS)}, along with \emph{v\textsubscript{size}} values for each of the eight different experimental interfaces and conditions trialled. Statistical tests between interfaces/conditions yielded no significant differences, at $\alpha$\emph{=0.05.} Probabilities that are used in the experiments reported in this chapter are \darkbluebox{highlighted.} Refer to Tables~\ref{tbl:snippets_simulation_probcosts} (page~\pageref{tbl:snippets_simulation_probcosts}) and~\ref{tbl:diversity_simulation_probcosts} (page~\pageref{tbl:diversity_simulation_probcosts}) for other interaction probabilities and costs for studies reported in Chapters~\ref{chap:snippets} and~\ref{chap:diversity} respectively.}
...
Both of these sections provide answers for this chapter's two research questions, \darkblueboxbold{RQ1} and \darkblueboxbold{RQ2}. Refer to Section~\ref{sec:serp:background} for further information on the questions that we posed.
...
We also ran comparisons between \blueboxbold{Average} and \blueboxbold{Always}, to determine if a significant difference existed there. Unsurprisingly, no significant difference was observed, with $p=0.78$ reported over \blueboxbold{SS1-FIX} and interface \blueboxbold{T2}. However, results clearly demonstrate that the upper bound \blueboxbold{Perfect} demonstrates significant performance improvements over the existing baseline approach across all stopping strategies and interfaces/conditions, solidifying our supporting evidence for \darkblueboxbold{RQ1}.
...
\begin{table}[t!]
    ...
    \begin{center}
        \begin{tabulary}{\textwidth}{L{0.25cm}@{\CS}L{3.55cm}@{\CS}D{1.4cm}@{\CS}D{1.4cm}@{\CSONEHALF}D{1.4cm}@{\CS}D{1.4cm}@{\CSONEHALF}D{1.4cm}@{\CS}D{1.4cm}@{\CS}}
            ...
            % T2
            \RS \multirow{3}{*}{\hspace*{-2mm}\rotatebox{90}{\hspace*{-7mm}\footnotesize Int. \blueboxbold{\textbf{T2}}}} & \lbluecell\small\textbf{SS1-FIX} & \cell \small \hspace*{-1mm} 21 & \cell \small \hspace*{-1mm} 74.04 & \cell \hspace*{-1mm} \small 24 & \cell \small \hspace*{-1mm} 70.68 & \cell \small \hspace*{-1mm} 24 & \cell \hspace*{-1mm} \small 76.94 \\
            \RS  & \lbluecell\small\textbf{SS2-NT} & \cell \small \hspace*{-1mm} 15 & \cell \small \hspace*{-1mm} 77.76 & \cell \hspace*{-1mm} \small 21 & \cell \small \hspace*{-1mm} 72.12 & \cell \small \hspace*{-1mm} 18 & \cell \hspace*{-1mm} \small 82.06 \\
            
            \RS  & \lbluecell\small\textbf{SS5-COMB} & \cell \small \hspace*{-1mm} 21,6 & \cell \small \hspace*{-1mm} 72.81 & \cell \hspace*{-1mm} \small 21,10 & \cell \small \hspace*{-1mm} 70.23 & \cell \small \hspace*{-1mm} 21,7 & \cell \hspace*{-1mm} \small 77.89 \\
            
            % ND-AD
            \RS\RS\RS \multirow{3}{*}{\hspace*{-2mm}\rotatebox{90}{\hspace*{-7mm}\footnotesize Cdn. \textbf{\dualbluebox{ND}{AD}}}} & \lbluecell\small\textbf{SS1-FIX} & \cell \small \hspace*{-1mm} 21 & \cell \small \hspace*{-1mm} 168.39 & \cell \hspace*{-1mm} \small 24 & \cell \small \hspace*{-1mm} 176.98 & \cell \small \hspace*{-1mm} 24 & \cell \hspace*{-1mm} \small 164.97 \\
            ...
            \RS  & \lbluecell\small\textbf{SS5-COMB} & \cell \small \hspace*{-1mm} 21,5 & \cell \small \hspace*{-1mm} 162.81 & \cell \hspace*{-1mm} \small 24,8 & \cell \small \hspace*{-1mm} 168.26 & \cell \small \hspace*{-1mm} 21,5 & \cell \hspace*{-1mm} \small 160.69 \\
