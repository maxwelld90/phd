...
\begin{table}[p!]
    \caption[Snippets Performance]{Results from the simulated what-if simulated performance runs (Chapter~\ref{chap:snippets}), showing the highest levels of~\gls{acr:cg} attained for each~\gls{acr:serp} level stopping component. (expand this discussion)}\vspace*{-2mm}
    ...
    \begin{center}
        \begin{tabulary}{\textwidth}{L{0.25cm}@{\CS}L{2.15cm}@{\CS}D{0.9cm}@{\CS}D{0.9cm}@{\CS}D{0.9cm}@{\CSONEHALF}D{0.9cm}@{\CS}D{0.9cm}@{\CS}D{0.9cm}@{\CSONEHALF}D{0.9cm}@{\CS}D{0.9cm}@{\CS}D{0.9cm}@{\CSONEHALF}}
            ...
            & & \multicolumn{3}{@{\hskip 0pt}c@{\CSONEHALF}}{\dbluecell\small\textbf{SS1-FIX}} & \multicolumn{3}{@{\hskip 0pt}c@{\CSONEHALF}}{\dbluecell\small\textbf{SS2-NT}} & \multicolumn{3}{@{\hskip 0pt}c@{\CSONEHALF}}{\dbluecell\small\textbf{SS11-COMB}}\\
            ...
            \RS \multirow{3}{*}{\hspace*{-2mm}\rotatebox{90}{\hspace*{-7mm}\footnotesize Int. \blueboxbold{\textbf{T2}}}} & \lbluecell\small\textbf{Always} & \cell \small \hspace*{-1mm} 10 & \cell \small \hspace*{-1mm} 6.33 & \cell \hspace*{-1mm} \small 2.50 & \cell \small \hspace*{-1mm} 7 & \cell \small \hspace*{-1mm} 6.16 & \cell \hspace*{-1mm} \small 2.49 & \cell \small \hspace*{-1mm} 10,10 & \cell \small \hspace*{-1mm} 5.33 & \cell \hspace*{-1mm} \small 2.52 \\
            \RS  & \lbluecell\small\textbf{Average} & \cell \small \hspace*{-1mm} 10 & \cell \small \hspace*{-1mm} 4.17 & \cell \hspace*{-1mm} \small 2.45 & \cell \small \hspace*{-1mm} 21 & \cell \small \hspace*{-1mm} 10.77 & \cell \hspace*{-1mm} \small 2.58 & \cell \small \hspace*{-1mm} 50,0 & \cell \small \hspace*{-1mm} 13.73 & \cell \hspace*{-1mm} \small 2.44 \\
            \RS  & \lbluecell\small\textbf{Perfect} & \cell \small \hspace*{-1mm} 10 & \cell \small \hspace*{-1mm} 4.45 & \cell \hspace*{-1mm} \small 2.98 & \cell \small \hspace*{-1mm} 8 & \cell \small \hspace*{-1mm} 5.07 & \cell \hspace*{-1mm} \small 3.11 & \cell \small \hspace*{-1mm} 50,5 & \cell \small \hspace*{-1mm} 10.72 & \cell \hspace*{-1mm} \small 3.00 \\
