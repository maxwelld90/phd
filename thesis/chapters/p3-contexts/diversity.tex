...
- what are our general trends?
- interesting to note that the clear difference between the two systems disappears.

- wow. across diversified systems, SS1 does the best. SS10 does the best for the ND systems.
- interesting!
- what does that say? does the retrieval system (diversified) improve things so much that it pays to employ a fixed depth approach? although 24 seems quite high! and is the non-diversified system so poor in comparison that you give up after 30 seconds? interesting nevertheless.

- again we see really clear trends in the plots.
- however the systems are no longer closely grouped together.
- D-AS is the best consistently. then ND AD. then D AD. then ND AS consistently offers the worst approximations.

- did stat tests in Table 8.13, but no sig diffs.
- also report the average. doesn't really show a clear winner, no sig diffs.

- ss6, ss7 and ss12 all consistently underestimate the depth.

- and what about total cg?
- the real-world searchers performed generally better than all of the simulated stopping strategies.
    ...
    - SS3 over ND-AS is the only strategy that offers a higher level of CG.
    - real-world searchers all outperform the stopping strategies.
