...
\begin{table}[t!]
    \caption[xx]{Results from the post-task surveys, consisting of both the behavioural- and system-based questions. Results shown are averages recorded for each of the four experimental conditions when considering the seven-point Likert scale. }
    ...
    \begin{tabulary}{\textwidth}{L{0.4cm}@{\CS}L{3.2cm}@{\CS}D{2.5cm}@{\CS}D{2.5cm}@{\CS}D{2.5cm}@{\CS}D{2.5cm}@{\CS}}
        ...
        \RS \multirow{6}{*}{\rotatebox{90}{\hspace*{-8mm}\textbf{Behavioural}}} & \lbluecell\textbf{Success} & \cell \small{x.xx$\pm$y.yy} & \cell \small{x.xx$\pm$y.yy} & \cell \small{x.xx$\pm$y.yy} & \cell \small{x.xx$\pm$y.yy}\\
        \RS & \lbluecell\textbf{Subject Speed} & \cell \small{xx$\pm$yy} & \cell \small{xx$\pm$yy} & \cell \small{xx$\pm$yy} & \cell \small{xx$\pm$yy}\\
        \RS & \lbluecell\textbf{Queries} & \cell \small{xx$\pm$yy} & \cell \small{xx$\pm$yy} & \cell \small{xx$\pm$yy} & \cell \small{xx$\pm$yy}\\
        \RS & \lbluecell\textbf{Documents} & \cell \small{xx$\pm$yy} & \cell \small{xx$\pm$yy} & \cell \small{xx$\pm$yy} & \cell \small{xx$\pm$yy}\\
        \RS & \lbluecell\textbf{Checks} & \cell \small{xx$\pm$yy} & \cell \small{xx$\pm$yy} & \cell \small{xx$\pm$yy} & \cell \small{xx$\pm$yy}\\
        \RS & \lbluecell\textbf{Enough} & \cell \small{xx$\pm$yy} & \cell \small{xx$\pm$yy} & \cell \small{xx$\pm$yy} & \cell \small{xx$\pm$yy}\\
        
        \RS\RS\RS \multirow{6}{*}{\rotatebox{90}{\hspace*{-8mm}\textbf{System}}} & \lbluecell\textbf{System Speed} & \cell \small{x.xx$\pm$y.yy} & \cell \small{x.xx$\pm$y.yy} & \cell \small{x.xx$\pm$y.yy} & \cell \small{x.xx$\pm$y.yy}\\
        \RS & \lbluecell\textbf{Difficulty} & \cell \small{xx$\pm$yy} & \cell \small{xx$\pm$yy} & \cell \small{xx$\pm$yy} & \cell \small{xx$\pm$yy}\\
        \RS & \lbluecell\textbf{Ease} & \cell \small{xx$\pm$yy} & \cell \small{xx$\pm$yy} & \cell \small{xx$\pm$yy} & \cell \small{xx$\pm$yy}\\
        \RS & \lbluecell\textbf{Happiness} & \cell \small{xx$\pm$yy} & \cell \small{xx$\pm$yy} & \cell \small{xx$\pm$yy} & \cell \small{xx$\pm$yy}\\
        \RS & \lbluecell\textbf{Cumbersome} & \cell \small{xx$\pm$yy} & \cell \small{xx$\pm$yy} & \cell \small{xx$\pm$yy} & \cell \small{xx$\pm$yy}\\
        \RS & \lbluecell\textbf{Confidence} & \cell \small{xx$\pm$yy} & \cell \small{xx$\pm$yy} & \cell \small{xx$\pm$yy} & \cell \small{xx$\pm$yy}\\
