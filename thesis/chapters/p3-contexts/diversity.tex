...
\begin{table}[t!]
    ...
    \RS\RS \multirow{2}{*}{\rotatebox{90}{\hspace*{-3mm}\textbf{Precision}}} & \lbluecell\textbf{P@5} & \cell 0.25$\pm$0.01* & \cell 0.29$\pm$0.01* \\
    \RS & \lbluecell\textbf{P@10} & \cell 0.22$\pm$0.01 & \cell 0.24$\pm$0.01 \\
    
    \RS\RS \multirow{2}{*}{\rotatebox{90}{\hspace*{-3mm}\textbf{$\alpha$DCG}}} & \lbluecell\textbf{$\alpha$DCG@5} & \cell 0.02$\pm$0.00* & \cell 0.04$\pm$0.00* \\
    \RS & \lbluecell\textbf{$\alpha$DCG@10} & \cell 0.03$\pm$0.00* & \cell 0.04$\pm$0.00* \\
    
    \RS\RS \multirow{2}{*}{\rotatebox{90}{\hspace*{-2mm}\textbf{AR}}} & \lbluecell\textbf{AR@5} & \cell 1.40$\pm$0.11* & \cell 3.39$\pm$0.21* \\
