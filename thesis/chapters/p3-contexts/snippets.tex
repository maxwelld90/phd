...
\begin{table}[t!]
    ...
    \begin{center}
        \begin{tabulary}{\textwidth}{L{0.00cm}@{\CS}L{1cm}@{\CS}D{0.64cm}@{\CS}D{0.64cm}@{\CS}D{0.64cm}@{\CSONEHALF}D{0.64cm}@{\CS}D{0.64cm}@{\CS}D{0.64cm}@{\CSONEHALF}D{0.64cm}@{\CS}D{0.64cm}@{\CS}D{0.64cm}@{\CSONEHALF}D{0.64cm}@{\CS}D{0.64cm}@{\CS}D{0.64cm}@{\CS}}
            ...
            \RS & \dbluecell\small\textbf{RW} & \cell \small \hspace*{-2.5mm} 11.10 & \cell \small \hspace*{-1mm} 1.10 & \cell \hspace*{-1mm} \small 2.58 & \cell \small \hspace*{-2.5mm} 11.24 & \cell \small \hspace*{-1mm} 1.14 & \cell \hspace*{-1mm} \small 2.28 & \cell \small \hspace*{-2.5mm} 10.23 & \cell \small \hspace*{-1mm} 1.20 & \cell \hspace*{-1mm} \small 2.47 & \cell \small \hspace*{-2.5mm} 10.02 & \cell \small \hspace*{-1mm} 1.21 & \cell \hspace*{-1mm} \small 2.66\\
