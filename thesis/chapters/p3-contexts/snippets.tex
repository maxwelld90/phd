...
The outline for both of these studies follow the general methodology, as discussed in Chapter~\ref{chap:method}. Before discussing the studies and their results, we begin with an overview of prior work that has examined the length of~\glsplural{acr:serp} and result summary snippets.
