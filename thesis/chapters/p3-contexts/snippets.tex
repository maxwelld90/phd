...
It should be noted that in order to determine the difference in performance or approximations attained by different result summary level stopping strategies, we employ significance testing. All tests in this section utilise the two-tailed Student's t-test, where $\alpha=0.05$. We compare the best performing or approximating stopping strategies against others. Here, we are interested in \emph{statistical non-significance,} meaning that compared stopping strategies are \emph{similar} to the best performing or approximating.
