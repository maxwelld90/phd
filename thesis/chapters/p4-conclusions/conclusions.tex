...
\subsection{\todo{Searcher Models and Realism}}
...
\begin{table}[t!]
    \caption[Observed cost per unit of gain]{Summarising statistics across the eight interfaces and conditions trialled. Included in this table is the reported average session time (\genericblack{Avg. S.T.}), mean \genericblack{\gls{acr:cg}} attained, and the cost per unit of~\gls{acr:cg}, or \genericblack{Cost/\gls{acr:cg} Unit}. All $\pm$ values denote the standard deviations. Values reported are over the real-world subjects of the two user studies conducted, as reported in Chapters~\ref{chap:snippets} and~\ref{chap:diversity}. Values for \genericblack{Chapter~\ref{chap:snippets} (10mins)} relate to the full ten minutes, rather than the first six minutes of search sessions as reported elsewhere. Refer to Section~\ref{sec:snippets:method:subjects} on page~\pageref{sec:snippets:method:subjects} for further information.}
    ...
    \begin{tabulary}{\textwidth}{L{0.4cm}@{\CS}L{3.85cm}@{\CS}D{3.3cm}@{\CS}D{3.3cm}@{\CS}D{3.3cm}@{\CS}}
        ...
        \RS \multirow{4}{*}{\rotatebox{90}{\hspace*{-4mm}\textbf{Chapter~\ref{chap:snippets}}}} & \lbluecell\textbf{T0} & \cell 353.18$\pm$44.22 & \cell 1.87$\pm$2.67 & \cell 188.87 \\
        \RS & \lbluecell\textbf{T1} & \cell 356.18$\pm$41.79 & \cell 1.83$\pm$2.32 & \cell 194.63 \\
        \RS & \lbluecell\textbf{T2} & \cell 366.49$\pm$39.82 & \cell 2.36$\pm$3.09 & \cell 155.29 \\
        \RS & \lbluecell\textbf{T4} & \cell 361.01$\pm$49.33 & \cell 1.87$\pm$1.87 & \cell 193.05 \\
        
        \RS\RS\RS \multirow{4}{*}{\rotatebox{90}{\hspace*{-5mm}\textbf{Chapter~\ref{chap:snippets} (10mins)}}} & \lbluecell\textbf{T0-10MINS} & \cell 538.18$\pm$54.99 & \cell 2.47$\pm$3.46 & \cell 217.89 \\
        \RS & \lbluecell\textbf{T1-10MINS} & \cell 549.45$\pm$32.73 & \cell 2.25$\pm$3.48 & \cell 244.20 \\
        \RS & \lbluecell\textbf{T2-10MINS} & \cell 548.46$\pm$40.78 & \cell 3.05$\pm$4.33 & \cell 179.82 \\
        \RS & \lbluecell\textbf{T4-10MINS} & \cell 547.16$\pm$30.04 & \cell 2.77$\pm$3.17 & \cell 197.53 \\
...
\subsection{\todo{Simulations of Interaction}}
