...
\begin{itemize}
    ...
    \item{Cell \darkbluebox{highlighting} is used throughout the tables within this thesis to represent values of interest -- whether they simply are the best reported, or to illustrate a statistically significant differences. Refer to the caption of each table for the specific meaning of what cell \cellbluebox{highlighting} denotes.}
