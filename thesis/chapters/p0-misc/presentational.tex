...
This thesis is typeset in 12-point Palatino (body) and \metafont\selectfont Foundry Sterling (headers) \normalfont\selectfont using \XeTeX\ version 0.99998, using a custom made \texttt{.cls} that is fully compliant with University of Glasgow College of Science and Engineering thesis regulations.
\end{preamble}