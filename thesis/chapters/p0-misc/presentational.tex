...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \item{Oft-repeated terms and descriptors use \inlineemph{Foundry Sterling for a less intrusive form of emphasis}.}
        
        \item{We refer to a number of different \emph{stopping strategies} throughout this thesis, each with their own name and at least one variable. These strategies are presented using the notation \inlinedualemph{Name}{@Value}.}
