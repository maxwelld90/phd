...
The main body of this thesis is typeset in 12 point Palatino (body) with 1\sfrac{1}{2} line spacing. Headers, figures and tables use \headerfont\selectfont Foundry Sterling\normalfont\selectfont. The thesis is compiled using \XeTeX\ version $0.99998$. A custom \TeX\ class (\texttt{.cls}) has been used that is compliant with University of Glasgow College of Science and Engineering thesis regulations.
