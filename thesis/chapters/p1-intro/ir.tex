...
\begin{itemize}
    \item[\raisebox{-.2\height}{\includegraphics[height=5mm]{figures/ch2-point1.pdf}}]{considering each of the individual components in isolation, as discussed above (e.g. exclusively examining querying behaviours); or}
    \item[\raisebox{-.2\height}{\includegraphics[height=5mm]{figures/ch2-point2.pdf}}]{considering the interactive search process as a whole, and attempting to capture and model an entire search session, from querying to document examination.}
\end{itemize}
...
\begin{itemize}
    ...
    \item{\blueboxbold{Document Utility Model} These models encode some form of document utility that provides a description of how utility or \emph{gain} can be derived from relevant documents that are examined; and}
...
We acknowledge that the measures discussed in this section are only a subset of the full range of measures that have been developed and trialled. For a more comprehensive summary, refer to~\cite{sanderson2010test}.
...
This section provides a brief overview of basic effectiveness measures widely used within~\gls{acr:ir} today from the perspective of system-sided evaluation -- or the evaluation of the generated ranked list of results.
