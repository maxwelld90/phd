...
\begin{itemize}
    ...
    \item{\blueboxbold{Document Examination} considers the process of examining a document for relevance to the underlying information need (\emph{document triage}~\citep{marshall1997triage}).}
