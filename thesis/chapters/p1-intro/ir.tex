...
\subsubsection{The~\glsfirst{acr:trec}}
...
\subsubsection{The~\gls{acr:trec} Searcher Model}
...
\subsection{\glsfirst{acr:iir}}\label{sec:ir_background:user:iir}
...
\subsection{The~\gls{acr:ir}/\gls{acr:iir} Spectrum}
As previously stated, the interactions that take place on a~\gls{acr:serp} are part of the wider~\gls{acr:iir} process. In the next section, we turn our attention to different kinds of study -- from system-focused to user-focused.

So there's this spectrum. Consider the comments from Leif,
