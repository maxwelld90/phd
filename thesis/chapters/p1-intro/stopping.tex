...
With the scope and background of this thesis now outlined, we now move towards Part~\cite{part:stopping}. In this following part, we begin to introduce the contributions that this thesis provides, beginning with an updated searcher model. We will also discuss how we operationalised the \emph{stopping heuristics} outlined in this chapter, turning them into a series of programmable \emph{stopping strategies.}