...
This is not to say that surfing no longer occurs. Information seekers today will typically use a retrieval system to find a particular domain, then begin surfing within the said domain to find the information that they seek, if such information is not found immediately by the retrieval system. However, with the large volume of information now online, retrieval systems are the most effective way to locate information. Helping \emph{\glsplural{glos:searcher}} realise this by developing efficient retrieval systems is seen as the \emph{raison d'\^{e}tre} of the study of~\gls{acr:ir}.
