...
\begin{itemize}
    ...
    \item[]{\blueboxbold{Chapter 6} This chapter outlines outlines our general methodology, detailing the high-level structure of the scientific method used in the empirical work discussed in Part III. We also provide a discussion of common approaches that we used across all subsequent chapters.}
\end{itemize}
...
\begin{itemize}
    ...
    \item[]{\blueboxbold{Chapter 8} In this chapter, we report on a user study examining how a searcher's stopping behaviour varies when subjected to conditions that vary the task, goal, and system used. We then again perform a simulated analyses to examine these stopping behaviours in more detail.}
