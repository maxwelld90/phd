...
\noindent
\blueboxbold{In a Nutshell – What do we do?}
Given all of the above, this thesis presents a model, and using a mixed methodology, we test it out.
