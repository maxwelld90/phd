...
The four categories can be considered as belonging to a \emph{spectrum} of~\gls{acr:ir} research. As shown by the blue bar at the bottom of Figure~\ref{fig:ch1-options}, this can vary between user focused research -- that considers the user and his or her interactions, needs, and so forth -- to more system sided research, that pays closer attention to low level factors of a retrieval system. These factors, for example, can include examination of different evaluation measures that can be used. This spectrum was defined by~\cite{kelly2009iir} as a means of classifying different~\gls{acr:ir} and~\gls{acr:iir} studies. We discuss this spectrum in more depth in Section~\ref{sec:ir_background:user}.
