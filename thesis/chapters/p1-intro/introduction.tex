...
%\gls{glos:summary}
%\gls{glos:recall}
%\gls{glos:summary_stopping}
%\gls{glos:serp_stopping}
%\gls{glos:session_stopping}
%\gls{glos:info_need}
\gls{acr:qrel}
