...
\newglossaryentry{glos:ar}{
    name={AR},
    description={\emph{Aspectual Recall} considers the number of documents returned by a retrieval system that make reference to at least one new \emph{aspect} of a particular topic. An interactive-based approach can also be considered, where documents by searchers are exclusively considered.},
}
...
\newglossaryentry{glos:rdbms}{
    name={RDBMS},
    first={RDBMS},
    description={A \emph{Relational DataBase Management System} is a type of database management system based upon thr relational model. At a minimum, a RDBMS provides data as a series of \emph{tables,} comprised of rows and columns, and the ability to create \emph{relationships} between said data.},
}
