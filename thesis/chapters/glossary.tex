...
\newglossaryentry{glos:qrel}{
    name={QREL},
    description={A \emph{Query RElevance Judgement} are a series of judgements that are assigned to documents within a corpus. Typically, these are considered over a per-topic basis, with binary judgements assigned -- one for being relevant, and the other not relevant. These are considered as the ground truth, or gold standard judgements of relevance.},
}
