...
\newglossaryentry{glos:mturk}{
    name={MTurk},
    first={MTurk},
    description={What is Amazon Mechanical Turk?}
}

\newglossaryentry{glos:set}{
    name={SET},
    first={SET},
    description={What is Search Economic Theory?}
}

\newglossaryentry{glos:esl}{
    name={ESL},
    first={ESL},
    description={What is Expected Search Length?}
}

\newglossaryentry{glos:oft}{
    name={OFT},
    first={OFT},
    description={What is Optimal Foraging Theory?}
}

\newglossaryentry{glos:mvt}{
    name={MVT},
    first={MVT},
    description={What is Marginal Value Theorem?}
}

\newglossaryentry{glos:prp}{
    name={PRP},
    first={PRP},
    description={What is Probability Ranking Principle?}
}

\newglossaryentry{glos:iprp}{
    name={iPRP},
    first={iPRP},
    description={What is Interactive Probability Ranking Principle?}
}