...
def get_observed_entities_for_list(ranking_diversity_qrels, topic, rankings_list):
    """
    ...
    for hit in rankings_list:
        ...
        entities = ranking_diversity_qrels.get_mentioned_entities_for_doc(topic, docid)
...
def diversify_results(ranking_diversity_qrels, results, topic, to_rank=30, lam=1.0):
    """
    ...
    for i in range(1, to_rank):
        observed_entities = get_observed_entities_for_list(ranking_diversity_qrels, topic, new_rankings)
